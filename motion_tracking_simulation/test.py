...
class chen():
    ...
    def SpeedToGo(self):
        ...
        if self.rho < 0.95:
            ...
            self.w = self.Kp_alpha * self.alpha + self.Kp_beta * self.beta  # positive value means turn left, negative value means turn right
    ...
    def move_to_pose(self, x_start, y_start, theta_start, x_goal, y_goal, theta_goal, L_x_chair, L_y_chair, R_x_chair, R_y_chair, F_x_chair, F_y_chair):
        ...
        while (self.rho > 0.78) and count < 50:
            count += 1
            # print("count =", count)
