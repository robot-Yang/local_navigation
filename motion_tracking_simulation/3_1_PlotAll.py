...
# @Last Modified time: 2020-06-11 22:49:53
...
class chen():
    ...
    def SpeedToGo(self):
        ...
        # self.v =  Kp_rho * (self.rho) * np.cos(self.alpha)
        # self.w =  Kp_alpha * np.sin(self.alpha) * np.cos(self.alpha) - Kp_beta * self.beta * ((np.sin(alpha_bar*np.pi/180))**2 - np.sin(self.alpha + self.beta)**2)

        # self.v =  Kp_rho * (self.rho) * np.cos((self.beta - self.alpha)/(90/180) * 0.5)
        # self.w =  Kp_alpha * np.sin(self.alpha) * np.cos(self.alpha) - Kp_beta * self.beta * ((np.sin(alpha_bar*np.pi/180))**2 - np.sin(-self.alpha + self.beta)**2)
        ...
        self.v =  k1 * self.rho * np.cos(self.alpha)
        ...
        # self.v =  k1 * self.rho * np.cos((self.alphaStar)/(50/180) * 0.5)
        # self.w =  k2 * np.sin(self.alpha)*np.cos(self.alpha) - k3 * self.beta + k4 * np.sin(self.alpha)*np.cos(self.alpha)*((np.sin(alpha_bar*np.pi/180))**2 - np.sin(self.alphaStar)**2)

        # self.v =  k1 * self.rho * np.cos(self.alpha) # * np.cos(self.alpha + self.beta) 
        # self.w =  k2 * np.sin(self.alpha)*np.cos(self.alpha) - k3 * self.beta
